...
router.add('/page2', function () {
  view.innerHTML = 'Router: /page2';
});

router.add('/page3', function () {
  view.innerHTML = 'Router: /page3';
});
},{"./router":"router.js","./index.scss":"index.scss"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/history.398d64e9.map